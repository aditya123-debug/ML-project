...
class DataTransformation:
    '''
    THIS FUNCTION IS RESPONSIBLE FOR DATA TRANSFORMATION FOR VARIOUS KINDS OF DATA
    
    '''
    def __init__(self):
        self.data_transformation_config=DataTransfromationConfig()
        
    def get_data_transformation_object(self):  #IT IS BASICALLY USED TO CREATE PICKLE FILES WHICH IS BASICALLY USED TO CONVERT THE CATEGORICAL FREATURES INTO NUMERICAL AND TO PERFROM STANDARD SCALAR 
         try:
