...
class DataIngestion:
    ...
    def initiate_data_ingestion(self):
        ...
        try:
            df=pd.read_csv('notebook/data/stud.csv')   # THE ONLY CHANGE YOU CAN MAKE IN THIS CODE IS ACCORDING TO THE SOURCE FROM WHICH YOU ARE ACCESSING THE DATABASE (EX:FROM MONGODB,API,ETC) 
